...
export function OverviewSection() {
  ...
  const locationData = useMemo(() => [
    { country: 'Addis Ababa', count: 197520, percentage: 100 },
    { country: 'Bahir Dar', count: 32985, percentage: 65 },
    { country: 'Dire Dawa', count: 10254, percentage: 35 }
  ], []);
  ...
  return (
    <div className="min-h-screen bg-overview-gradient p-3 sm:p-4 lg:p-6 smooth-scroll">
      ...
      <div className={`max-w-7xl mx-auto grid gap-4 lg:gap-6 ${isMobile
          ? 'grid-cols-1 gap-3'
          : isTablet
        ...
        {/* Left Column */}
        <div className={`space-y-4 lg:space-y-6 ${isMobile ? 'order-1' : isTablet ? 'md:col-span-1 order-1' : 'order-1'
          }`}>
          ...
          <Card className="bg-white dark:bg-gray-800 shadow-lg rounded-2xl p-4 sm:p-6 hover:shadow-xl transition-all duration-300">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">@samrawitwelde_</span>
              </div>
            ...
            <div className="mb-6">
              <div className="flex gap-2 sm:gap-4 mb-4 border-b border-gray-200 dark:border-gray-700">
                <button
                  ...
                  className={`text-xs sm:text-sm font-medium pb-2 px-1 border-b-2 transition-colors ${activeTab === 'locations'
                ...
                <button
                  ...
                  className={`text-xs sm:text-sm font-medium pb-2 px-1 border-b-2 transition-colors ${activeTab === 'age'
                      ? 'text-gray-900 dark:text-white border-blue-500'
                      : 'text-gray-500 dark:text-gray-400 border-transparent hover:text-gray-700 dark:hover:text-gray-300'
                    }`}
                >
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors cursor-pointer">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900 dark:text-white text-xs sm:text-sm">@samrawitwelde_</p>
              ...
              <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors cursor-pointer">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900 dark:text-white text-xs sm:text-sm">@samrawitwelde_backup</p>
        ...
        <div className={`space-y-4 lg:space-y-6 ${isMobile ? 'order-2' : isTablet ? 'md:col-span-1 order-2' : 'order-2'
          }`}>
        ...
        <div className={`space-y-4 lg:space-y-6 ${isMobile ? 'order-3' : isTablet ? 'md:col-span-2 order-3' : 'order-3'
          }`}>
